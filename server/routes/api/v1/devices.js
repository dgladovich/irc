...
const context = require('../public/config.json');
const db = require('../db');
...
//= ===================================
    ...
    .get('/services/:id/works', (req, res, next) => {
        DeviceWork.findAll({
    ...
    //      MAKING SERVICE
    //= ===================================
    .put('/:deviceID/services/:serviceID', (req, res, next) => {
        DeviceService
    ...
    //= ===================================
    .put('/:deviceID/unsheduled', (req, res, next) => {
        History
            .create({
                dev: req.params.deviceID,
    ...
    .put('/services/:serviceID/works/:workID', (req, res, next) => {
        DeviceWork
